...
<div id="wrapper">
  ...
  <form action="Get_Taken_ExamID" method="post">
    ...
    <div align="center">
      <p>
        <% out.println("<tr><td><h4><span style=\"color:red;\">Exam Name-</span>" + pb.getName() + "</td>  <td></td><td><span style=\"color:red;\">Subject 1-</span>" + pb.getSub1() + "</td> <td></td> <td><span style=\"color:red;\">Subject 2-</span>" + pb.getSub2() + "</td> <td></td> <td><span style=\"color:red;\">Subject 3-</span>" + pb.getSub3() + "</td> <td></td> <td><span style=\"color:red;\">Total Marks-</span>" + pb.getTotal()  );
