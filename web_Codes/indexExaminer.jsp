    ...
    <article>
      ...
      <form action ="ValidateExaminerLogin" method ="POST">
        <table>
          <tr>
            <td>Username:</td>
            <td><input type="text" id="username" required="required" name ="username" onblur="validateUsername()"></td>
            <td><label id="errorusername"></label></td>
          </tr>

          <tr>
            <td>Password:</td>
            <td><input type="password" id="pass" required="required" name ="pass" onblur="validatePassword()"></td>
