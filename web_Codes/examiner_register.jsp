...
<div id="wrapper">
  ...
  <form action ="ValidateExaminerReg" method ="POST">
    <table>
      <tr>
        <td>Username:</td>
        <td><input type="text" id="username" required="required" name ="username"></td>
      </tr>

      <tr>
        <td>Password:</td>
        <td><input type="password" id="pass" required="required" name ="pass"></td>
      </tr>

      <tr>
        <td> Subject1 : <input type ="text" required="required" name="sub1" size="20" > </td>

        <td>Subject2 : <input type ="text" required="required" name="sub2"  size="20" > <br></td>
      </tr>
      <tr>
        <td>Email Address : <input type ="email" required="required" name="email" > </td>
      </tr>
      <tr>
