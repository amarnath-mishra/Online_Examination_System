...
<div id="wrapper">
  ...
  <div id="hero">
    <article>
      ...
      <h3></h3><marquee direction="right" width="70%">Welcome Examinees please login first</marquee></h3>
      ...
      <form action ="ValidateLogin" method ="POST">
        <table>
          <tr>
            <td>Username:</td>
            <td><input name ="username" type="text" id="username" required="required" placeholder="Enter Username" onblur="validateUsername()"></td>
            <td><label id="errorusername"></label></td>
          </tr>

          <tr>
            <td>Password:</td>
            <td><input name ="pass" type="password" id="pass" required="required" placeholder="Enter Password" onblur="validatePassword()"></td>
    ...
    <div id ="auto_slide">
      ...
      <div class="side-bar wow animated flipInX" id="NOTICES" align="center"><p style="font-family:'Josefin Slab', serif;font-size:22px; color:rgb(170, 58, 16);font-weight:bold; text-decoration:underline">NOTICES AND ANNOUNCEMENTS</p>
        <div class="Link2 wobble-horizontal" style="font-family:'Josefin Slab', serif;font-size:20px";method="POST"><br><a href="ShowExamDirect" target="_BLANK">   Added New Exams
        </a><br><br></div>
